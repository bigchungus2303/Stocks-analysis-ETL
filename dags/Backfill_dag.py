...
from dags.snowpark.load_trino_into_snowflake_test import get_data_and_schema_from_trino
...
@dag(
    description="A dag to backfill capstone table stock activity",
    default_args={  
        "owner": schema,
...
def back_fill_raw_data_load_dag_v1():
    MAANG_STOCKS = [
    ...
    # Example date range
    START_DATE_STR = '01-01-2020' # "DD-MM-YYYY" format
    ...
    create_daily_step >> create_staging_step >> load_to_staging_step >> load_to_production_step >> drop_staging_table >> run_dq_check >> cleaning_step

back_fill_raw_data_load_dag_v1()
